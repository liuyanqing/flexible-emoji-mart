// @ts-nocheck
import i18n_en from '@flexible-emoji-mart/data/i18n/en.json'
...
async function _init(props) {
  ...
  if (!Data) {
    Data =
      ...
      (await fetchJSON(
        `https://cdn.jsdelivr.net/npm/@flexible-emoji-mart/data@latest/sets/${emojiVersion}/${set}.json`,
      ))
  ...
  I18n =
    ...
    (locale == 'en'
      ? i18n_en
      : await fetchJSON(
          `https://cdn.jsdelivr.net/npm/@flexible-emoji-mart/data@latest/i18n/${locale}.json`,
        ))
